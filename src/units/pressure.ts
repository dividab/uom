...
// Pressure
export const KiloPascal = Kilo("KiloPascal", Pascal);
export const HectoPascal = Hecto("HectoPascal", Pascal);
...
export const DeciPascal = Deci("DeciPascal", Pascal);
...
export const MilliBar = Milli("MilliBar", Bar);
